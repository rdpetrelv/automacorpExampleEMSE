...
INSERT INTO ROOM(id, name, floor, target_temperature) VALUES(-10, 'Room1', 1, 20.0);
INSERT INTO SP_WINDOW(id, window_status_id, name, room_id) VALUES(-10, -9, 'Window 1', -10);

INSERT INTO ROOM(id, name, floor, temperature_id, target_temperature) VALUES(-9, 'Room2', 1, -10, 20.0);
